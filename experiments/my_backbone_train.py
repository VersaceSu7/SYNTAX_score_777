...
from .my_backbone_dataset import SyntaxDataset
from syntax_pre.backbone_model import SyntaxLightningModule


@click.command()
@click.option("-r", "--dataset-root", type=click.Path(exists=True), required=True, help="path to dataset root (e.g. data).")
@click.option("--meta-json", type=str, default="part9.json", show_default=True, help="metadata json path relative to dataset root.")
